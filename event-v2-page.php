...
<body class="<?= $version ? 'version-' . $version : '' ?> ">
	...
	<section class="main-page-now" id="main-page-now">
    <div class="container">
        <div class="main-page-now__content">
            <div class="main-page-now__breadcrumbs"><img data-src="img/main-page-now/arrow.svg" alt="" class="lazy">К событиям</div>
            <div class="main-page-now__date">21 марта, 12:00</div>
            <h1 class="main-page-now__title">Чемпионат и&nbsp;первенства Санкт-Петербурга среди юношей и&nbsp;юниоров</h1>
            <div class="main-page-now__wrap">
                <a href="" class="button main-page-now__buy">Купить билет</a>
                <a href="#popup-application" data-fancybox class="button main-page-now__application">Заявиться на соревнования</a>
            </div>
        </div>
    </div>
</section>

<div class="popup-application" id="popup-application" style="display: none;">
	...
	<section class="reviews acco" id="reviews">
    <div class="container">
        <div class="reviews__section">
            
            <div class="reviews__poster">Ринг ММА 1, 16 августа 2021,<br> старт 11:00 (время московское)</div>
            <a href="#" class="reviews__video">
                <div class="reviews__video-img">
                    <img data-src="img/reviews/picture.png" alt="" class="lazy reviews__video-picture">
                    <div class="reviews__video-live">live</div>
                    <div class="reviews__video-player">
                        <img data-src="img/video-page/play.png" alt="" class="lazy">
                    </div>
                    <div class="reviews__video-overlay">
                        <div>Начнётся через 3&nbsp;часа</div>
                        <span>Сегодня, в&nbsp;11:30</span>
                    </div>
                </div>
            </a>
            <div class="reviews__desc">
                <div class="reviews__desc-wrap">
                    <div class="reviews__desc-online">
                        <span>Трансляция началась в 12:00, 21 марта 2021</span><span>Сейчас смотрят 16,2 тыс зрителей</span>
                    </div>
                    <span class="reviews__desc-subtitle">Rugby Union of Russia</span>
                </div>
                <div class="reviews__desc-social social">
            ...
            <div class="acco-item-rv">
                    ...
                    <div class="bg-position acco-content-rv">
	...
	<section class="program acco" id="program">
    <div class="container acco-item">
        
        <div class="bg-position bg-title acco-trigger">
            <h2 class="program__title title">Участникам<img data-src="img/main-page-now/theme.svg" alt="" class="lazy"></h2>
        </div>
        
        <div class="program__box acco-content">
...
<section class="fights acco" id="fights">
    <div class="container">
        <div class="fights__box acco-item">
            ...
            <div class="fights__poster acco-content">
	...
	<section class="news acco " id="news">
    <div class="container acco-item">
        ...
        <div class="row news__box acco-content">
	...
	<section class="adres acco" id="adres">
    <div class="container acco-item">
        ...
        <div class="adres__box acco-content">
