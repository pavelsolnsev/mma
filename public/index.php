        ...
        <div class="event__slider">
            ...
            <article class="event__item">
                <a class="event__wrap" href="/">
                    <img src="img/main/events-1.jpg" alt="" class="event__img">
                    <div class="event__content">
                        <div class="event__content-date">3-6 июня &bull; Казань, Россия, Республика Татарстан, Казань, Спартаковская улица, 1</div>
                        <h3 class="event__content-title">Чемпионат России по&nbsp;ММА среди мужчин и&nbsp;женщин</h3>
                    </div>
                </a>
            </article>
            ...
            <article class="event__item">
                <a class="event__wrap" href="/">
                    <img src="img/main/events-2.jpg" alt="" class="event__img">
                    <div class="event__content">
                        <div class="event__content-date">5 июня • Las Vegas, Nevada, USA</div>
                        <h3 class="event__content-title">2021&nbsp;UFC Fight Night Marcin Tybura VS&nbsp;Walt Harris Apex</h3>
                    </div>
                </a>
            </article>
            ...
            <article class="event__item">
                <a class="event__wrap" href="/">
                    <img src="img/main/events-3.jpg" alt="" class="event__img">
                    <div class="event__content">
                        <div class="event__content-date">10 июня • Atlantic City, New Jersey, United States</div>
                        <h3 class="event__content-title">Professional Fighters League&nbsp;4 Regular Season Ocean Casino Resort</h3>
                    </div>
                </a>
            </article>
            ...
            <article class="event__item">
                <a class="event__wrap" href="/">
                    <img src="img/main/events-4.jpg" alt="" class="event__img">
                    <div class="event__content">
                        <div class="event__content-date">25-28 июня • г. Ульяновск</div>
                        <h3 class="event__content-title">Всероссийский мастерский турнир по&nbsp;ММА среди мужчин</h3>
                    </div>
                </a>
            </article>
...
<div class="popular" id="popular">
    ...
    <a href="/" class="popular-item">
        <h3>Стерлинг отказался от&nbsp;боя с&nbsp;Яном 15&nbsp;мая, может выбыть на&nbsp;9&nbsp;месяцев</h3>
        <span class="text">Сегодня</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>Конор МакГрегор обещает вернуться к&nbsp;олдскульной подготовке</h3>
        <span class="text">Сегодня</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>Азамат Керефов снялся с&nbsp;боя накануне турнира ACA 121</h3>
        <span class="text">Вчера</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>Джордж Сент-Пьер: Хабиб&nbsp;&mdash; самый устрашающий боец независимо от&nbsp;веса</h3>
        <span class="text">Вчера</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>Следующий бой Федора Емельяненко может пройти в&nbsp;конце лета в&nbsp;США</h3>
        <span class="text">Вчера</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>Боец ММА Плиев рассказал, как провел раунд с&nbsp;оторванным пальцем</h3>
        <span class="text">Вчера</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>Хабиб Нурмагомедов уверен, что его двоюродный брат Абубакар сможет добиться большего в&nbsp;UFC</h3>
        <span class="text">Вчера</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>СМИ: бывший чемпион UFC в&nbsp;тяжелом весе Джуниор дос Сантос покинул организацию</h3>
        <span class="text">Вчера</span>
    </a>
    
    <a href="/" class="popular-item">
        <h3>Президент UFC Уайт верит, что Хамзат Чимаев продолжит спортивную карьеру</h3>
        <span class="text">Вчера</span>
    </a>
    ...
    <a href="/" class="popular-button button">Больше материалов</a>
                    ...
                    <div class="articles__news">
                        ...
                        <div class="articles__news-wrap">
                            ...
                            <article class="news-block">
                                <a href="/">
                                    <img data-src="img/articles/article/article-2.png" alt="" class="lazy">
                                    <div>
                                        <h3>Конор Макгрегор заявил, что бой с&nbsp;Порье отменен и&nbsp;хочет драться с&nbsp;кем-то другим</h3>
                                        <span class="text">Вчера</span>
                                    </div>
                                </a>
                            </article>
                            ...
                            <article class="news-block">
                                <a href="/">
                                    <img data-src="img/articles/article/article-3.png" alt="" class="lazy">
                                    <div>
                                        <h3>Девушка-боец MMA Пейдж Ванзант показала впечатляющую стойку</h3>
                                        <span class="text">Вчера</span>
                                    </div>
                                </a>
                            </article>
                            ...
                            <article class="news-block">
                                <a href="/">
                                    <img data-src="img/articles/article/article-4.png" alt="" class="lazy">
                                    <div>
                                        <h3>Диана Авсарагова в&nbsp;дебютном бою на&nbsp;Bellator нокаутировала соперницу из&nbsp;США за&nbsp;29&nbsp;секунд</h3>
                                        <span class="text">12 апреля</span>
                                    </div>
                                </a>
                            </article>
                    ...
                    <div class="articles__video-slider">
                        ...
                        <a class="articles__video-item" href="/">
                            <div class="articles__video-img">
                                <img data-src="img/articles/video/video-1.png" alt="" class="lazy">
                                <div class="video"><img data-src="img/articles/video/play.png" alt="" class="lazy"><span>00:00</span></div>
                            </div>
                            <h3>Чемпионат и&nbsp;первенство Приморского края по&nbsp;смешанному боевому единоборству (ММА) 2021</h3>
                        </a>
                        
                        <a class="articles__video-item" href="/">
                            <div class="articles__video-img">
                                <img data-src="img/articles/video/video-2.png" alt="" class="lazy">
                                <div class="video"><img data-src="img/articles/video/play.png" alt="" class="lazy"><span>00:00</span></div>
                            </div>
                            <h3>Чемпионат и&nbsp;первенство Приморского края по&nbsp;смешанному боевому единоборству (ММА) 2021</h3>
                        </a>
                        ...
                        <a class="articles__video-item" href="/">
                            <div class="articles__video-img">
                                <img data-src="img/articles/video/video-3.png" alt="" class="lazy">
                                <div class="video"><img data-src="img/articles/video/play.png" alt="" class="lazy"><span>00:00</span></div>
                            </div>
                            <h3>Чемпионат и&nbsp;первенство Приморского края по&nbsp;смешанному боевому единоборству (ММА) 2021</h3>
                        </a>
                        ...
                        <a class="articles__video-item" href="/">
                            <div class="articles__video-img">
                                <img data-src="img/articles/video/video-4.png" alt="" class="lazy">
                                <div class="video"><img data-src="img/articles/video/play.png" alt="" class="lazy"><span>00:00</span></div>
                            </div>
                            <h3>Чемпионат и&nbsp;первенство Приморского края по&nbsp;смешанному боевому единоборству (ММА) 2021</h3>
                        </a>
