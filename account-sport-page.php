        ...
        <div class="account__wrapper">
            <div class="account__photo">
                ...
                <div class="account__photo-button">
                    <button class="button account__photo-button_delete">Удалить фото</button>
                    <button class="button account__photo-button_change">Изменить фото</button>
                </div>
            ...
            <form action="" class="form">
                ...
                <div class="form__wrapper">
                    ...
                    <div class="form__items">
                        ...
                        <div class="form__item">
                            <span>Псевдоним (необязательно)</span>
                    ...
                    <div class="form__items">
                        ...
                        <div class="form__item">
                            <span>Город</span>
                            <input type="text" name="text" placeholder="Париж" class="form__input" required="" value="">
                        </div><!-- form__item -->
                        <div class="form__item">
                            <span>Email</span>
                    ...
                    <div class="form__button">
                        <button href="" class="form__button-save button">Сохранить</и>
                        <button href="" class="form__button-none button">Отменить</button>
                    </div>
                ...
                <div class="form__wrapper">
                    <h3 class="form__title">Титулы</h3>

                    <div class="form__items">
                        <div class="form__item">
                            <span>Название</span>
                            <div class="form__select select">
                                <select data-placeholder="Выберите титул" class="catalog__select">
                                    <option value=""></option>
                                    <option value="Второй фильтр">Второй фильтр</option>
                                    <option value="Третий фильтр">Третий фильтр</option>
                                    <option value="Четвертый фильтр">Четвертый фильтр</option>
                        ...
                        <div class="form__item">
                            ...
                            <input type="text" name="text" placeholder="Введите название " class="form__input" required="" value="">
                        </div><!-- form__item -->
                    </div>

                    <div class="form__more">
                        <span>Добавить титул</span>
                        <a href="#" class="button">Добавить еще </a>
                    </div>

                    <div class="form__button">
                        <button class="form__button-save button">Сохранить</button>
                        <button class="form__button-none button">Отменить</button>
                    </div>
                ...
                <div class="form__wrapper">
                    <h3 class="form__title">Данные</h3>
                    ...
                    <div class="form__items">
                        <div class="form__item">
                            <span>Стиль</span>
                            <div class="form__select select">
                                <select data-placeholder="Греко-римская борьба" class="catalog__select">
                                    <option value=""></option>
                                    <option value="Второй фильтр">Второй фильтр</option>
                                    <option value="Третий фильтр">Третий фильтр</option>
                                    <option value="Четвертый фильтр">Четвертый фильтр</option>
                        ...
                        <div class="form__item">
                            <span>Название клуба/федерации</span>
                            <input type="text" name="text" placeholder="Спортивная федерация" class="form__input" required="" value="">
                        </div><!-- form__item -->
                    </div>
                    ...
                    <div class="form__button">
                        <button class="form__button-save button">Сохранить</butt>
                        <button class="form__button-none button">Отменить</button>
                    </div>
