...
<div class="sidebar__bottom">
  <div class="sidebar__bottom_content">
        ...
        <div class="broadcast-2__box">
            <div class="broadcast-2__wrapper">
                <article class="broadcast-2__col">
                    <a href="/" class="broadcast-2__item">
                        <div class="broadcast-2__img">
            ...
            <a href="/" class="broadcast-2__button button more-button">Показать ещё <img data-src="img/common/more.svg" alt="" class="lazy"></a>
            <picture class="articles__banner_2 broadcast-2__bunner">
                <source media="(max-width: 575px)" srcset="img/broadcast-2/banner-mob.png">
                <img alt="" class="lazy-loaded" src="img/broadcast-2/banner.png">
            </picture>
        </div>
    </div>
</section>
